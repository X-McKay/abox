...
GitHub Actions runners. They require no hardware virtualization, no
MicroSandbox runtime assets, and no host credentials.
...
See `scripts/local/` for suites that require virtualization, the
MicroSandbox runtime, or real API credentials.
